...
from . import kuaishou_meizhuang_bp
...
@kuaishou_meizhuang_bp.route('/', strict_slashes=False)
@module_required('kuaishou_meizhuang')
def index():
...
@kuaishou_meizhuang_bp.route('/import_orders', methods=['POST'])
@module_required('kuaishou_meizhuang')
def import_orders():
    return _do_import(request.files.getlist('files'), 'kuaishou_meizhuang/orders', import_orders_files)


@kuaishou_meizhuang_bp.route('/import_fund_flow', methods=['POST'])
@module_required('kuaishou_meizhuang')
def import_fund_flow():
    return _do_import(request.files.getlist('files'), 'kuaishou_meizhuang/fund_flows', import_fund_flow_files)


@kuaishou_meizhuang_bp.route('/import_after_sales', methods=['POST'])
@module_required('kuaishou_meizhuang')
def import_after_sales():
    return _do_import(request.files.getlist('files'), 'kuaishou_meizhuang/aftersales', import_after_sales_files)


@kuaishou_meizhuang_bp.route('/export_data', methods=['POST'])
@module_required('kuaishou_meizhuang')
def export_data():
    try:
...
@kuaishou_meizhuang_bp.route('/export_commission_summary', methods=['POST'])
@module_required('kuaishou_meizhuang')
...
@kuaishou_meizhuang_bp.route('/export_commission_details', methods=['POST'])
@module_required('kuaishou_meizhuang')
